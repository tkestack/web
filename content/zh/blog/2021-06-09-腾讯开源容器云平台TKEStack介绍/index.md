...
更多信息请参考[集群管理](https://tkestack.github.io/docs/user-guide/platform-console/cluster-mgmt.html)
...
更多信息请参考[访问管理](https://tkestack.github.io/docs/user-guide/platform-console/access-mgmt/)
...
更多日志信息请参考[日志管理](https://tkestack.github.io/docs/user-guide/platform-console/operation-mgmt/log-collect.html)

#### 平台巡检

巡检工具 kube-javis，通过 plugin 插件的方式灵活配置和扩展，多维度的检查 TKEStack 平台下集群的健康状况，支持集成到 TKEStack 平台中，定期运行并输出诊断结果和修复建议。

更多详细信息请关注[kube-javis](https://github.com/tkestack/kube-jarvis)
...
更多详情请参考[扩展组件](https://tkestack.github.io/docs/key-features/)
